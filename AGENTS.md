...
- 新建或维护博客写作、正文 HTML 和配图补充 Skill 时，接入 `hugo-tech-blog-writer/references/dev-review-contract.md`：默认 Dev，最终全文由独立子代理使用 `article-readability-check` 审核，通过不自动转为 Public。
